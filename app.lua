...
task.spawn(function()
merchants.autoBuyLoop("SmelterMerchantService1", function() return on end, function() end)
end)
end
end) or nil,
...
autoFarmOn = false
pcall(function() if App.UI and App.UI.setAutoFarm then App.UI.setAutoFarm(false) end end)
end
end) or nil,
-- 🔹 Sahur Hopper
