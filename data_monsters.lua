...
local M = {
  ...
  forcedMonsters = {
    ...
    "Matteoo",
    "Sea Urchin",
    "Gorillo WatermellondriIIo",
    "Axolotus",
    "Oyster",
    "Rhino Rhino Toasterino",
    "Cog",
    "Vault",
    "Ecco CavaIIo Virtuoso",
    "LeruIeruIeruIe",
    "Helmet",
    "PeIicini Pananini",
    "Pile of Gold",
    ...
    "Pillar",
    "Espressona Signorra",
    "Shimpanzini WatermeIonini Kingini",
    "Ti Ti Ti Ti Sahur",
    "Car",
    "Satellite Dish",
    "Racotucotulu",
    "Electricity Pole",
    "Trenostruzzo Turbo 3K",
    "Nightmare Monster Sahur",
    "Tombstone",
    "TrikitrakateIas",
    "Old Coffin",
    ...
    "Rune",
    "AIessio",
    "Ketupat Kepat Kupat Prekupat",
    "CentraIucci NucIearucci",
    "Trash Pile",
    "Radioactive Barrel",
    "Big Pipe",
    "Dar Dir Durr Dorr TeIur Dadar",
    "Tirilikalika TiriIikalako",
    "BambercIat Crococlat",
    "TigrIIi Grapefrutunni",
    "Brick",
    "BuIbito Bandito Traktorito",
    "Gangster Footeera",
    "Screw",
    "BOSS",
    "Tiny Stars",
