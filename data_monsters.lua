...
forcedMonsters = {
  ...
  'OrcaIero OrcaIa','Capuccino Assasino','Igloo','Tic Tac Tok Afammoc','Pinkaroo',
  'Frozen Fish','Blizzy','Marshmallow','Aurox','SaIamino Pinguino','Toyboo','Spookit',
  'Gear','Winding Key','Matteoo','Sea Urchin','Gorillo WatermellondriIIo','Axolotus',
  'Oyster','Rhino Rhino Toasterino','Cog','Vault','Ecco CavaIIo Virtuoso',
  'LeruIeruIeruIe','Helmet','PeIicini Pananini','Pile of Gold','Cocossini Mamma',
  'Pillar','Espressona Signorra','Shimpanzini WatermeIonini Kingini','Ti Ti Ti Ti Sahur',
